...
// oauth4webapi sender aud som [issuer, token_endpoint], men ID-porten krever kun issuer som string.
...
if (process.env.IDPORTEN_TJENESTEEIER_CLIENT_ID) {
  providers.push(
    buildIdportenProvider({
